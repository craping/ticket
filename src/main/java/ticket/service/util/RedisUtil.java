...
public class RedisUtil {
	...
	public static boolean setObject(String key, Object object, int timeout) {
		...
		try {
			...
			logger.error("Redis setObject(key:{}, object:{}, timeout:{})时异常：", key, object, timeout, e);
		}
		return result;
	}
	...
	public static Object getObject(String key) {
		...
		try {
			...
			logger.error("Redis getObject(key:{})时异常：", key, e);
		}
		return object;
	}
	...
	public static boolean setString(String key, String value, int timeout) {
		...
		try {
			...
			logger.error("Redis setObject(key:{}, object:{}, timeout:{})时异常：", key, value, timeout, e);
		} finally {
			releaseRedis(jedis);
		}
		return false;
	...
	public static String getString(String key) {
		...
		try {
			...
			logger.error("Redis getString(key:{})时异常：", key, e);
		} finally {
			releaseRedis(jedis);
		}
		return null;
	...
	public static boolean del(String key) {
		...
		try {
			...
			logger.error("Redis del(key:{})时异常：", key, e);
		} finally {
			releaseRedis(jedis);
		}
		return result;
...
//					System.out.println(field + "=" + value);
	...
	public static void setKV(Jedis jedis, Object obj) {
		Class<?> clazz = obj.getClass();
